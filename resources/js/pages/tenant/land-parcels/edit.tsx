...
export default function LandParcelEdit({ organization, parcel, managers, canDeleteLandParcel }: Props) {
                        ...
                        <>
                            <div className="grid gap-6 rounded-xl border border-input p-6 md:grid-cols-2">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="name" name="name" type="text" required autoComplete="off" defaultValue={parcel.name} />
                                    <InputError message={errors.name} />
                                </div>

                                <div className="grid gap-2">
                                    <Label htmlFor="title_deed_number">Title deed no. (optional)</Label>
                                    <Input id="title_deed_number" name="title_deed_number" type="text" autoComplete="off" defaultValue={parcel.title_deed_number ?? ''} />
                                    <InputError message={errors.title_deed_number} />
                                </div>

                                <div className="grid gap-2">
                                    <Label htmlFor="acreage">Acreage (optional)</Label>
                                    <Input id="acreage" name="acreage" type="number" step="0.01" min="0" autoComplete="off" defaultValue={parcel.acreage ?? ''} />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="address" name="address" type="text" autoComplete="off" defaultValue={parcel.address ?? ''} />
                                    <InputError message={errors.address} />
                                </div>

                                <div className="grid gap-2">
                                    <Label htmlFor="city">City (optional)</Label>
                                    <Input id="city" name="city" type="text" autoComplete="off" defaultValue={parcel.city ?? ''} />
                                    <InputError message={errors.city} />
                                </div>

                                <div className="grid gap-2">
                                    <Label htmlFor="latitude">Latitude (optional)</Label>
                                    <Input id="latitude" name="latitude" type="number" step="any" autoComplete="off" defaultValue={parcel.latitude ?? ''} />
                                    <InputError message={errors.latitude} />
                                </div>

                                <div className="grid gap-2">
                                    <Label htmlFor="longitude">Longitude (optional)</Label>
                                    <Input id="longitude" name="longitude" type="number" step="any" autoComplete="off" defaultValue={parcel.longitude ?? ''} />
                                ...
                                <div className="grid gap-2 md:col-span-2">
                                    <Label htmlFor="images">Replace / add photos (optional)</Label>
                                    <input
                                        id="images"
                                        name="images[]"
                                        type="file"
                                ...
                                {canDeleteLandParcel && (
                                    <Dialog>
                                        ...
                                        <DialogContent>
                                            ...
                                            <DialogDescription>
                                                This permanently deletes the parcel and its photos. Please
